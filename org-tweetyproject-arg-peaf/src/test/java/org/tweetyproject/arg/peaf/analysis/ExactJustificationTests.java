...
public class ExactJustificationTests {
    ...
    public void computeSimple() {
        ...
        double p = JustificationAnalysis.compute(query, new ExactPEAFInducer(peafTheory), new PreferredReasoner());
    ...
    public void computeSimpleAttack() {
        ...
        double p = JustificationAnalysis.compute(query, new ExactPEAFInducer(peafTheory), new PreferredReasoner(), true, true);
    ...
    public void computeSimpleAttack2() {
        ...
        double p = JustificationAnalysis.compute(query, new ExactPEAFInducer(peafTheory), new PreferredReasoner(), true, false);
