...
import org.tweetyproject.arg.peaf.io.aif.ersdata.Schemes;
...
public class ERSControl {
    ...
    private boolean createNodesFrom(ArrayList arrayList) {
        ...
        while (iter.hasNext()) {
            ...
            if (mapNode.get("type").equals("I") ||
				mapNode.get("type").equals("P")) {

                //System.out.println(mapNode);
                //eval=((String) mapNode.get("eval")).toUpperCase();
                String input = (String) mapNode.get("input");
        ...
        while (iter.hasNext()) {
            ...
            if (nd.get("type").equals("CA") || nd.get("type").equals("RA")) {
	    		...
	    		if(((String)nd.get("type")).equals("CA")){
                    System.err.println("Con link is not supported.");
//	    			//this is a con link
